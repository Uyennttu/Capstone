					...
					<div class="navbar-nav ml-auto py-0">
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu border-0 rounded-0 m-0">
								<a href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">Queensland</a> <a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">New South Wales</a> <a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">Victoria</a> <a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">South Australia</a> <a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">Tasmania</a><a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">Western Australia</a><a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">Northern Territory</a><a
									href="tour_by_dest.jsp?dest=${tour.state}"
									class="dropdown-item">Australian Capital Territory</a>
							</div>
						</div>
			...
			<div
				...
				<div class="row pt-5">
					<div class="col-lg-3 col-md-6 mb-5">
						...
						<p>Explore the wonders of the world with Traveler. Immerse
							yourself in captivating landscapes, vibrant cultures, and
							unforgettable experiences. Our mission is to make your travel
							dreams a reality.</p>
					...
					<div class="col-lg-3 col-md-6 mb-5">
						<h5 class="text-white text-uppercase mb-4"
							style="letter-spacing: 5px;">Services</h5>
					...
					<div class="col-lg-3 col-md-6 mb-5">
						<h5 class="text-white text-uppercase mb-4"
							style="letter-spacing: 5px;">Useful Links</h5>
						<div class="d-flex flex-column justify-content-start">
							<a class="text-white-50 mb-2" href="#"><i
					...
					<div class="col-lg-3 col-md-6 mb-5">
						...
						<p>
							<i class="fa fa-phone-alt mr-2"></i>+061 345 67890
						</p>
						<p>
							<i class="fa fa-envelope mr-2"></i>info@traveler.com
						</p>
